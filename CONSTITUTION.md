# CONSTITUTION — WebSocket-Client-TS

Project-specific governance for the **WebSocket-Client-TS** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
